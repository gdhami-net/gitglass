...
[`examples/`](examples/) — React, Vue and Svelte are roughly ten lines
of glue each, Angular is a full component that fits on one screen,
because the core is plain DOM.
